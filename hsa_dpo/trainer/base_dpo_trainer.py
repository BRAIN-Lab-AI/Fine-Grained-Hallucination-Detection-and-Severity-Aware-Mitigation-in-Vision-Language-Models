...
class BaseDPOTrainer(Trainer):
    ...
    Args:
        ...
        use_chosen_score (`bool`, defaults to False):
            Whether to use chosen scores in DPO loss calculation.
        use_rejected_score (`bool`, defaults to True):
            Whether to use rejected scores in DPO loss calculation.
    ...
    def dpo_loss(
        ...
        chosen_scores: torch.FloatTensor = None,
        rejected_scores: torch.FloatTensor = None,
        ...
        if chosen_scores is None:
            chosen_scores = torch.tensor(1.0, device=policy_chosen_logps.device)
