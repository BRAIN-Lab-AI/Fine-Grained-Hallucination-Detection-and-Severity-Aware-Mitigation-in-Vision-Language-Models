...
\title{Fine-Grained Hallucination Detection and Severity-Aware Mitigation in Vision-Language Models}
...
\author{%
  ...
  \texttt{s202283240@kfupm.edu.sa}\\
  \And
  Alwaleed Alharthi\\
  Department of Information and Computer Science\\
  King Fahd University of Petroleum and Minerals\\
  Dhahran, Saudi Arabia\\
  \texttt{s202158850@kfupm.edu.sa}\\
  \And
  Muzammil Behzad\\
  Department of Information and Computer Science\\
  King Fahd University of Petroleum and Minerals\\
  Dhahran, Saudi Arabia\\
  \texttt{muzammil.behzad@kfupm.edu.sa}\\
}
